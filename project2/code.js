  ...
  var bgTable = $(go.Part, "Auto",
    ...
    $(go.Panel, "Table",
      ...
      $(go.Panel, "TableRow", { row: 0, background: "#404040" },
        ...
        // width total 480
        $(go.TextBlock, "관제 시스템",
          { column: 1, font: "12pt sans-serif", stroke: "white", margin: 10, width: 90, textAlign: "center" }),
        $(go.TextBlock, "고객 담당자",
          { column: 2, font: "12pt sans-serif", stroke: "white", margin: 10, width: 90, textAlign: "center" }),
        $(go.TextBlock, "장애 관리 책임자",
          { column: 3, font: "12pt sans-serif", stroke: "white", margin: 10, width: 125, textAlign: "center" }),
        $(go.TextBlock, "벤더",
          { column: 4, font: "12pt sans-serif", stroke: "white", margin: 10, width: 65, textAlign: "center" }),
        $(go.TextBlock, "연계 프로세스",
          { column: 5, font: "12pt sans-serif", stroke: "white", margin: 10, width: 105, textAlign: "center" })),
      ...
      $(go.Panel, "TableRow", { row: 1 },
        $(go.TextBlock, "장애 발생", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 17, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 2 },
        $(go.TextBlock, "장애\n감지/접수", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 90, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 3 },
        $(go.TextBlock, "장애 유형\n식별/등급", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 70, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 4 },
        $(go.TextBlock, "1차 해결", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 175, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 5 },
        $(go.TextBlock, "장애 배정", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 30, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      ...
      $(go.Panel, "TableRow", { row: 7 },
        $(go.TextBlock, "문제 관리", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 20, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 8 },
        $(go.TextBlock, "장애 종료", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 20, textAlign: "center", verticalAlignment: go.Spot.Center })
      )
    )
