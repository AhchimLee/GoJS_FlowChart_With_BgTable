function init() {
  ...
  $(go.Shape, { fill: "white", stroke: "#BFBFBF" }),
    $(go.Panel, "Table",
      ...
      $(go.TextBlock, "고객 담당자",
          { column: 1, font: "12pt sans-serif", stroke: "white", margin: 10, width: 120, textAlign: "center" }),
      $(go.TextBlock, "구성 및 변경 담당자",
          { column: 2, font: "12pt sans-serif", stroke: "white", margin: 10, width: 150, textAlign: "center" }),
      $(go.TextBlock, "구성 및 변경\n책임자",
          { column: 3, font: "12pt sans-serif", stroke: "white", margin: 10, width: 100, textAlign: "center" }),
      ...
      $(go.TextBlock, "표준\n프로세스\n수립", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 115, textAlign: "center"  }),
      $(go.TextBlock, "", { column: 1, margin: 2 }),
      $(go.TextBlock, "", { column: 2, margin: 2 })
      ),
      $(go.Panel, "TableRow", { row: 2 },
      $(go.TextBlock, "구성 및\n변경 요청", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, textAlign: "center" }),
      $(go.TextBlock, "", { column: 1, margin: 2 }),
      $(go.TextBlock, "", { column: 2, margin: 2 })
      ),
      $(go.Panel, "TableRow", { row: 3 },
      $(go.TextBlock, "구성 및\n변경 요청\n검토", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 180, textAlign: "center" }),
      $(go.TextBlock, "", { column: 1, margin: 2 }),
      $(go.TextBlock, "", { column: 2, margin: 2 })
      ),
      $(go.Panel, "TableRow", { row: 4 },
      $(go.TextBlock, "구성 및\n변경 수행", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 280, textAlign: "center" }),
      $(go.TextBlock, "", { column: 1, margin: 2 }),
      $(go.TextBlock, "", { column: 2, margin: 2 })
      ),
