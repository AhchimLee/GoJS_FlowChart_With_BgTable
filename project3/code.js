  ...
  var bgTable = $(go.Part, "Auto",
    ...
    $(go.Panel, "Table",
      ...
      $(go.Panel, "TableRow", { row: 0, background: "#404040" },
        ...
        // width total 480
        $(go.TextBlock, "SR 요청자",
          { column: 1, font: "12pt sans-serif", stroke: "white", margin: 10, width: 130, textAlign: "center" }),
        $(go.TextBlock, "SR 담당자",
          { column: 2, font: "12pt sans-serif", stroke: "white", margin: 10, width: 130, textAlign: "center" }),
        $(go.TextBlock, "벤더",
          { column: 3, font: "12pt sans-serif", stroke: "white", margin: 10, width: 110, textAlign: "center" }),
        $(go.TextBlock, "연계 프로세스",
          { column: 4, font: "12pt sans-serif", stroke: "white", margin: 10, width: 135, textAlign: "center" })),
      ...
      $(go.Panel, "TableRow", { row: 1 },
        $(go.TextBlock, "SR 요청", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 240, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 2 },
        $(go.TextBlock, "SR 처리", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 340, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 3 },
        $(go.TextBlock, "검증", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 80, textAlign: "center", verticalAlignment: go.Spot.Center })
      ),
      $(go.Panel, "TableRow", { row: 4 },
        $(go.TextBlock, "종료", 
          { column: 0, font: "bold 12pt sans-serif", stroke: "gray", margin: 20, height: 50, textAlign: "center", verticalAlignment: go.Spot.Center })
      )
    )
  )
